    ...
    internal class Service : IRequestHandler<Request, BaseResponse<Response>>
    {
        ...
        public async Task<BaseResponse<Response>> Handle(Request request, CancellationToken ct)
        {
            ...
            if (!validationResult.IsValid)
                return new ErrorResponse<Response>(422, "Um ou mais campos estão incorretos", validationResult.Errors);
            ...
            return new SuccessResponse<Response>(201, "User created", data);
        }
    }
}